...
export default function CompanyProfile({ companys, recuiterdata }) {
    // Core State
    ...
    const handleSubmit = async (e) => {
        ...
        const writerId = formData.get('writerId')?.trim();
        ...
        if (!writerId) newErrors.writerId = "Writer ID is required";
