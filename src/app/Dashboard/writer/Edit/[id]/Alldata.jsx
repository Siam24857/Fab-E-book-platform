                        ...
                        <motion.div className="space-y-6" variants={itemVariants}>
                            ...
                            >
                                <div className="space-y-1.5">
                                    ...
                                    <input 
                                        name="writerId" 
                                        defaultValue={company?.writerId || id || ''} 
                                        placeholder="e.g. W001"
                                        readOnly
                                        className="w-full bg-gray-100 border border-gray-200 text-gray-600 rounded-xl px-4 py-3 outline-none cursor-not-allowed opacity-70"
                                    />
                                </div>
